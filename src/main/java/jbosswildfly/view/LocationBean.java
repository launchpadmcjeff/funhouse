...
import jbosswildfly.model.Location;
...
public class LocationBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.location.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public Converter getConverter()
   {
      ...
      final LocationBean ejbProxy = this.sessionContext.getBusinessObject(LocationBean.class);
